...
void main() {
  testWidgets('HabitsTracker calls onToggle when cell tapped', (tester) async {
    final week = <String>['2025-01-06','2025-01-07','2025-01-08','2025-01-09','2025-01-10','2025-01-11','2025-01-12'];
    final habits = [const HabitRowData(id: 1, title: 'Drink water', priority: 'medium')];
    bool toggled = false;
      ...
      home: Scaffold(
        body: SizedBox(
          ...
          child: HabitsTracker(
            habits: habits,
            weekYmd: week,
            statsById: const <int, Map<String, dynamic>>{1: {'weekHeatmap': []}},
            onToggle: (id, ymd, completed) { toggled = true; },
          ),
        ),
      ),
    ));
